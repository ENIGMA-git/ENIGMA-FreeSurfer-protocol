...
###### to run >> ./make_ENIGMA_QC_cortical_internal_webpage.sh ${dirO} (where $dirO is the output directory specified for the Matlab script, i.e., /enigma/Parent_Folder/FreeSurfer/QC_cortical_internal/)
